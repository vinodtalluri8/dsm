...
export class DatalistService extends BaseServiceService {
  ...
  // private serverURL = this.serverUrl + 'DIVA-SystemMaintService/dataListOnApplication';
  private serverURL = this.serverUrl + this.systemMaintServiceUrl + 'dataListOnApplication';
